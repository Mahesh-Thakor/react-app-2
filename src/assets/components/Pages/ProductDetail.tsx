...
const ProductDetail: React.FC = () => {
    ...
    function changeImage(event: React.MouseEvent<HTMLImageElement>) {
        event.preventDefault();
        const elementTarget = event.target as HTMLImageElement;
        if (elementTarget.tagName.toLowerCase() === 'img') {
            const mainImage = document.getElementById('mainImage') as HTMLImageElement;
            if (mainImage) {
                mainImage.src = elementTarget.src;
            }
        }
    }
                        ...
                        <div className="w-full md:w-1/2 px-4">
                            ...
                            <div className="mb-6">
                                ...
                                <input 
                                    ...
                                    className="w-12 text-center rounded-md border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-black dark:text-white shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" />
                            </div>
