...
const ProductCard: React.FC = () => {
  ...
  const handleClick = (event:React.MouseEvent) => {
    ...
    return (
        <div onClick={handleClick} className="mt-2 w-72 group border-gray-100/30 flex max-w-xs flex-col self-center overflow-hidden rounded-lg border bg-gray-700 shadow-md">
            <a onClick={handleClick} className="relative mx-3 mt-3 flex h-60 overflow-hidden rounded-xl" href="#">
            ...
            <div className="mt-4 px-5 pb-5">
                ...
                <div className="mt-2 mb-5 flex items-center justify-between">
                    <p>
                        ...
                        <span className="text-sm text-red-700 line-through">$699</span>
                    </p>
                </div>
                <a onClick={handleClick} href="/" className="hover:border-white/40 flex items-center justify-center rounded-md border border-transparent bg-blue-600 px-5 py-2.5 text-center text-sm font-medium text-white focus:outline-none focus:ring-4 focus:ring-blue-300">
